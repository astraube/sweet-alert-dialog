...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.ProgressWheel_progressCircleRadius, circleRadius);
        ...
        float baseSpinSpeed =
                a.getFloat(R.styleable.ProgressWheel_progressSpinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.ProgressWheel_progressBarSpinCycleTime, (int) barSpinCycleTime);
