 ...
 */
public class ProgressWheelNew extends View {
    ...
    /**
     * The constructor for the ProgressWheelJ
     *
     * @param context
     * @param attrs
     */
    public ProgressWheelNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.ProgressWheelNew));
    }
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.ProgressWheelNew_pwBarWidth, barWidth);
        rimWidth = (int) a.getDimension(R.styleable.ProgressWheelNew_pwRimWidth, rimWidth);
        spinSpeed = (int) a.getDimension(R.styleable.ProgressWheelNew_pwSpinSpeed, spinSpeed);
        barLength = (int) a.getDimension(R.styleable.ProgressWheelNew_pwBarLength, barLength);

        delayMillis = a.getInteger(R.styleable.ProgressWheelNew_pwDelayMillis, delayMillis);
        if (delayMillis < 0) { delayMillis = 10; }

        // Only set the text if it is explicitly defined
        if (a.hasValue(R.styleable.ProgressWheelNew_pwText)) {
            setText(a.getString(R.styleable.ProgressWheelNew_pwText));
        }

        barColor = a.getColor(R.styleable.ProgressWheelNew_pwBarColor, barColor);
        textColor = a.getColor(R.styleable.ProgressWheelNew_pwTextColor, textColor);
        rimColor = a.getColor(R.styleable.ProgressWheelNew_pwRimColor, rimColor);
        circleColor = a.getColor(R.styleable.ProgressWheelNew_pwCircleColor, circleColor);
        contourColor = a.getColor(R.styleable.ProgressWheelNew_pwContourColor, contourColor);

        textSize = (int) a.getDimension(R.styleable.ProgressWheelNew_pwTextSize, textSize);
        contourSize = a.getDimension(R.styleable.ProgressWheelNew_pwContourSize, contourSize);
